...
contract MockLandUtils {
  ...
  function latLonToGeohash5(int256[2] memory point, uint8 precision) public returns(uint256 geohash5) {
  ...
  function latLonToUtm(int256[2] memory point) public returns(uint256 geohash5) {
